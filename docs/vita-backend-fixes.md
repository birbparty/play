...
`docs/vita-backend-eval.md` verified that the vendored `vita_homebrew` backend
from fork commit `412011ec5c950ebf85f717b57722bb9298329686` compiles with
VitaSDK, can be included in a static SoLoud archive, and links into a minimal
Vita smoke ELF when `-lpthread` is added to the Vita runtime link group.
...
The remaining Vita work is Play integration, not a SoLoud fork fix:
